      ...
      switch (DBGMCU_IDCODE & 0xfff)
        {
          ...
          case 0x495: // STM32WB55xx
            TargetInterface.pokeWord(0xE0042004, 1<<2|1<<1|1<<0); // enable low-power mode debugging
            TargetInterface.pokeWord(0xE0042040, 1<<12|1<<11); // turn off WWDG and IWDG in debug mode
            break;
          default:
    ...
    switch ((TargetInterface.peekWord(0xE0042000) & 0xfff))
      {
        ...
        case 0x468:
          return "STM32G4xxx6/STM32G4xxx8/STM32G4xxxB";
        case 0x469:
          return "STM32G4xxxC/STM32G4xxxE";
        case 0x470: // STM32L4R/STM32L4S
    ...
    switch ((TargetInterface.peekWord(0xE0042000) & 0xfff))
      {
        ...
        case 0x469:
          return (family=="STM32G473" || family=="STM32G474" || family=="STM32G483" || family=="STM32G484") && (density=="C" || density=="E");
        case 0x470: // STM32L4R/STM32L4S
          return (family=="STM32L4R5" || family=="STM32L4R7" || family=="STM32L4R9" || family=="STM32L4S5" || family=="STM32L4S7" || family=="STM32L4S9");
        case 0x495:
          return (family=="STM32WB55");
        default:
          switch ((TargetInterface.peekWord(0x5C001000) & 0xfff))
            {
              case 0x450:
